...
proc cluster_response_tls {tls_cluster} {
    ...
    test "CLUSTER SLOTS with different connection type -- tls-cluster $tls_cluster" {
        ...
        set cluster_client [sider_cluster 127.0.0.1:$pport 0]
    ...
    set cluster [sider_cluster 127.0.0.1:[srv 0 port]]
    set cluster_pport [sider_cluster 127.0.0.1:[srv 0 pport] 0]
