...
start_cluster 3 0 {tags {external:skip cluster}} {
    ...
    test "Disconnect link when send buffer limit reached" {
        ...
        # memory to overflow it. If it is set too high, Sider may get OOM killed by kernel before this
