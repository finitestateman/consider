...
start_server {tags {"modules"}} {
    ...
    test {startup moduleconfigs} {
        ...
        catch {exec src/sider-server --moduleconfigs.string "hello"} err
        assert_match {*Module Configuration detected without loadmodule directive or no ApplyConfig call: aborting*} $err

        # Bad config value
        catch {exec src/sider-server --loadmodule "$testmodule" --moduleconfigs.string "rejectisfreed"} err
        ...
        catch {exec src/sider-server --loadmodule "$testmodule" noload --moduleconfigs.string "hello"} err
