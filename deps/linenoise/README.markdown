...
A minimal, zero-config, BSD licensed, readline replacement used in Sider,
MongoDB, and Android.
 ...
 * Smaller programs not using a configure script not supporting line editing at all (A problem we had with Sider-cli for instance).
